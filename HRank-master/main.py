...
parser.add_argument(
    '--resume',
    type=str,
    default='/code/HRank-master/pretrained_models/resnet_56.pt',#'/code/HRank-master/pretrained_models/resnet_56.pt',
...
if args.dataset == 'cifar10':
    ...
    train_dataset = my_Data_Set('/dataset/train.txt',
                                transform=data_transforms['train'], loader=Load_Image_Information)
    test_dataset = my_Data_Set('/dataset/train.txt',
...
for cov_id in range(args.start_cov, len(convcfg)):
    ...
    if cov_id == 0:
        ...
        pruned_checkpoint = torch.load(args.resume, map_location='cuda:0')#uda:0
